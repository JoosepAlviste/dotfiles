...
def parse_opts():
    ...
    k('column select left', 'left', 'select columnar left')
    k('column select right', 'right', 'select columnar right')
    k('column select up', 'up', 'select columnar up')
    k('column select down', 'down', 'select columnar down')

    g('colors')
    o('selection_foreground', '#c0c4cd', option_type=to_color)
    o('selection_background', '#4e5a65', option_type=to_color)
