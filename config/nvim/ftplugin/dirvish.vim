...
nnoremap <buffer> <c-p> <cmd>lua require('j.plugins.fzf.functions').files()<cr>

" Grep inside the hovered folder
nnoremap <buffer> <leader>ff <cmd>lua require('j.plugins.fzf.functions').grep_folder(vim.fn.fnamemodify(vim.fn.getline('.'), ':.'))<cr>
