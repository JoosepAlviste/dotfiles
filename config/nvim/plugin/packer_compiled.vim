...
_G.packer_plugins = {
  ["gitsigns.nvim"] = {
    loaded = true,
    path = "/Users/joosep.alviste/.local/share/nvim/site/pack/packer/start/gitsigns.nvim"
  },
  ["material.vim"] = {
    loaded = true,
  ...
  ["nvim-treesitter"] = {
    loaded = true,
    path = "/Users/joosep.alviste/.local/share/nvim/site/pack/packer/start/nvim-treesitter"
  },
  ["packer.nvim"] = {
    loaded = false,
    needs_bufread = false,
  ...
  playground = {
    loaded = true,
    path = "/Users/joosep.alviste/.local/share/nvim/site/pack/packer/start/playground"
  },
  ["plenary.nvim"] = {
    loaded = true,
    path = "/Users/joosep.alviste/.local/share/nvim/site/pack/packer/start/plenary.nvim"
  },
  ["scoro.vim.git"] = {
    loaded = true,
