...
call s:h("typescriptInterfaceExtends", { "fg": s:purple })
call s:h("typescriptInterfaceName", { "fg": s:light_blue })
call s:h("typescriptInterfaceHeritage", { "fg": s:light_blue })
call s:h("typescriptClassKeyword", { "fg": s:purple })
call s:h("typescriptClassExtends", { "fg": s:purple })
call s:h("typescriptClassName", { "fg": s:light_blue })
call s:h("typescriptClassHeritage", { "fg": s:light_blue })
call s:h("typescriptAccessibilityModifier", { "fg": s:purple })
...
call s:h("typescriptOptionalMark", { "fg": s:cyan })
...
call s:h("typescriptIdentifierName", { "fg": s:white })
...
call s:h("typescriptAliasDeclaration", { "fg": s:light_blue })
call s:h("typescriptProp", { "fg": s:yellow })
call s:h("typescriptKeywordOp", { "fg": s:purple })
call s:h("typescriptOperator", { "fg": s:purple })
call s:h("typescriptNodeGlobal", { "fg": s:dark_yellow })
call s:h("typescriptDecorator", { "fg": s:purple })
call s:h("typescriptReadonlyModifier", { "fg": s:purple })
