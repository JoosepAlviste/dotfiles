" GraphQL Support for typescriptreact filetypes
" This is copied from 
" https://github.com/jparise/vim-graphql/blob/master/after/syntax/tsx.vim
" so if vim-graphql adds support for `typescriptreact` filetypes then this 
" file can be removed
