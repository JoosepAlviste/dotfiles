...
function! joosep#autocomplete#setup_mappings() abort
  ...
  execute 'inoremap <buffer> <silent> ' . g:UltiSnipsJumpForwardTrigger .
        \ ' <C-R>=joosep#autocomplete#expand_or_jump("N")<CR>'
  execute 'snoremap <buffer> <silent> ' . g:UltiSnipsJumpForwardTrigger .
        \ ' <Esc>:call joosep#autocomplete#expand_or_jump("N")<CR>'
  execute 'inoremap <buffer> <silent> ' . g:UltiSnipsJumpBackwardTrigger .
        \ ' <C-R>=joosep#autocomplete#expand_or_jump("P")<CR>'
...
function! joosep#autocomplete#teardown_mappings() abort
...
function! joosep#autocomplete#expand_or_jump(direction) abort
